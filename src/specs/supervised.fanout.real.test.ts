...
describeIfOpenRouter('Supervised Router Fan-out (real providers, guarded)', () => {
  ...
  test('fan-out aggregates outputs from OpenAI and OpenRouter when enabled', async () => {
    ...
    history.push(new HumanMessage('Summarize the benefits of fan-out vs single-model briefly.'));
